...
The project is deployed and can be accessed at [https://roxiler-backend-sarvjitkumar-projects.vercel.app](https://roxiler-backend-sarvjitkumar-projects.vercel.app). You can use the following APIs to interact with the system.
